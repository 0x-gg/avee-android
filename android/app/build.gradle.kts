...
val mStorePassword: String? = System.getenv("AVEE_STORE_PASSWORD") ?: localProperties.getProperty("storePassword")
val mKeyAlias: String? = System.getenv("AVEE_KEY_ALIAS") ?: localProperties.getProperty("keyAlias")
val mKeyPassword: String? = System.getenv("AVEE_KEY_PASSWORD") ?: localProperties.getProperty("keyPassword")
