...
import com.avee.vpn.extensions.getIpv4RouteAddress
import com.avee.vpn.extensions.getIpv6RouteAddress
import com.avee.vpn.extensions.toCIDR
import com.avee.vpn.models.AccessControlMode
...
class AveeVpnService : VpnService(), BaseServiceInterface {
    ...
    override fun onRevoke() {
        Log.d("AveeVpnService", "onRevoke: runState=${GlobalState.runState.value}")
    ...
    inner class LocalBinder : Binder() {
        fun getService(): AveeVpnService = this@AveeVpnService
    ...
    override fun onDestroy() {
        Log.d("AveeVpnService", "onDestroy: runState=${GlobalState.runState.value}")
