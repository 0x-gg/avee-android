...
import com.avee.vpn.plugins.ServicePlugin
...
class MainActivity : FlutterActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // `com.avee.vpn/navigation` MethodChannel on init.
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.avee.vpn/navigation")
        ...
        EventChannel(flutterEngine.dartExecutor.binaryMessenger, "com.avee.vpn/navigation/events")
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.avee.vpn/device_id")
            .setMethodCallHandler { call, result ->
