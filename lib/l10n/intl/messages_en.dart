...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "restartCoreDesc": MessageLookupByLibrary.simpleMessage("Restart the proxy core"),
    "coreStatusRunning": MessageLookupByLibrary.simpleMessage("Running"),
    "coreStatusRestarting": MessageLookupByLibrary.simpleMessage("Restarting..."),
    "coreStatusStopped": MessageLookupByLibrary.simpleMessage("Stopped"),
    "runtimeConfig": MessageLookupByLibrary.simpleMessage("Runtime config"),
    "runtimeConfigNotAvailable": MessageLookupByLibrary.simpleMessage("Runtime config is not available yet. Start VPN first."),
    ...
    "includeInVpn": MessageLookupByLibrary.simpleMessage("Include in VPN"),
    "excludeFromVpn": MessageLookupByLibrary.simpleMessage("Exclude from VPN"),
    "whitelistModeDesc": MessageLookupByLibrary.simpleMessage("Only selected apps will use VPN. All other apps will bypass it."),
    "blacklistModeDesc": MessageLookupByLibrary.simpleMessage("Selected apps will bypass VPN. All other apps will use it."),
    "hwidNotSupported": MessageLookupByLibrary.simpleMessage("HWID is not enabled on this device. Please enable it in the application settings."),
    "coreUpdate": MessageLookupByLibrary.simpleMessage("Update core"),
    "coreUpdateAvailable": MessageLookupByLibrary.simpleMessage("Update available"),
    "coreUpdateCurrent": MessageLookupByLibrary.simpleMessage("Up to date"),
    "coreUpdateDownloading": MessageLookupByLibrary.simpleMessage("Downloading..."),
    "coreUpdateSuccess": MessageLookupByLibrary.simpleMessage("Core updated, restarting..."),
    "coreUpdateFailed": MessageLookupByLibrary.simpleMessage("Update failed"),
    "coreUpdateChecking": MessageLookupByLibrary.simpleMessage("Checking..."),
