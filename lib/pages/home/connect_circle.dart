...
double connectSizeFor(BuildContext context) {
...
class ConnectCircle extends ConsumerStatefulWidget {
  const ConnectCircle({required this.buttonSize});

  final double buttonSize;

  @override
  ConsumerState<ConnectCircle> createState() => _ConnectCircleState();
}

/// Global notifier for the connect button's screen-space center.
/// Written by [ConnectCircle].
final connectButtonCenter = ValueNotifier<Offset?>(null);

class _ConnectCircleState extends ConsumerState<ConnectCircle>
  ...
  @override
  void didUpdateWidget(covariant ConnectCircle oldWidget) {
