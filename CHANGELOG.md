...
- fix: use sideload flavor for universal APK
- fix: use sideload flavor for universal apk

## v1.0.3

- Merge pull request #6 from 0x-gg/codex/avee-ecosystem-foundation

- fix: pass Android flavor to release packager
- fix: pass Android flavor to distributor

## v1.0.2

- Merge pull request #5 from 0x-gg/codex/avee-ecosystem-foundation

- fix: package sideload universal apk
- fix: package sideload universal apk path

- fix: package sideload universal apk path

- style: format AVEE client API tests

- feat: consume AVEE managed profile endpoint

- feat: gate VPN start on AVEE stack compatibility

- fix: connect prepared profile and verify tunnel

- fix: harden logout and bitmap loading

- fix: use decimal traffic units

- feat: show subscription traffic usage

- fix: align account help and plan action

- feat: unify account and plan flows

- fix: harden managed profile sync and show traffic remaining

- fix: preserve selected location across Android reconnects

- chore: bump Android release to 0.9.2

- fix: sync and apply selected vpn locations

- refactor: remove obsolete mobile subscription screen

- chore: bump Android release to 0.9.1

- chore: bump Android release to 0.9.0

- chore: bump Android release to 0.8.15

- route home profile button to account and deduplicate subscriptions

- simplify account page and show ended trial offer

- show explicit revocation notice on forced sign out

- improve revocation handling and location status UI

- fix locations, mihomo routing, and release version

- fix: clear stale error on logout

- fix: close login dialog and hide trial warning

- fix: explain HWID device limit

- Simplify guest onboarding screen

- Improve device login trial protection and location latency

- Sync panel state and publish release 0.8.7

- Fix subscription purchase and management UI

- Finalize AVEE ID account flow and release updates

- Update ID-only onboarding test

- Replace recovery flow with AVEE ID login

- Bump Android release to 0.8.6

- Fix Android 15 edge-to-edge and large-screen support

- Fix emulator launch script when no emulator is running.

- Fix account deletion flow and persist recovery credentials locally.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Scale AVEE UI across phones and tablets for Play screenshots.

- Add width-driven layout scale for shell, dialogs, sheets, and notifications. Keep fresh-device reset gated to sideload debug builds only so Play release anti-abuse stays intact.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Fill AVEE screens edge-to-edge on tablets and large displays.

- Replace centered max-width layout with full-height sections and scaled hero graphics so onboarding and home match phone proportions on any screen size.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Replace legacy launcher art with geometric AVEE logo.

- Remove old text-based round icon path, regenerate mipmaps from Logo_512x512, and bump versionCode to 2026074508.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Fix tablet layout and connect flow, update AVEE logo for Play release.

- Center content on wide screens, start trial from Connect instead of empty Subscription, regenerate launcher icons, and bump versionCode to 2026074507.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Show trial and subscription time remaining in the account UI.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Rebrand dropweb to AVEE across the project and rebuild Play artifacts.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Point legal links to aveevpn.com instead of API legal pages.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Auto-pick a random online server on the home screen.

- Remove Remnawave Hosts subtitle, center the location panel, and select a random available server instead of showing Choose location. Also add Play build flavor, integrity hook, legal URLs, and internal release notes.

- Stabilize AVEE design and production VPN flow

- Finalize the working mobile design and connect account trials, Remnawave locations and profiles, native Android VPN core packaging, and reliable connection lifecycle into a stable VPN build.

- Co-authored-by: Cursor <cursoragent@cursor.com>

- Translate Android subscription flow to English

- Apply Solar Editorial Android design and English UI

- Replace authenticated dashboard with minimal signal UI

- Redesign Android shell with minimal motion UI

- Disable legacy dashboard on Android

- Polish Neon Glass cards and simplify menu

- Redesign mobile shell with Neon Glass branding

- fix: hide legacy empty subscription guidance on Android

- ci: add reproducible GPL source bundle audit

- ci: publish validated debug APK artifact

- fix: keep desktop profile dialog import

- ci: fetch history for scoped format check

- ci: make Android validation dispatchable and diff-scoped

- fix: remove Android legacy profile actions

- feat: send stable device fingerprint for trial guard

- feat: add AVEE onboarding and managed trial flow

- fix: replace upstream disclaimer with AVEE disclosure

- fix: block stale Play entitlement starts

- feat: enforce managed profile on Play

- feat: add guarded Platega checkout to Android

- build: publish signed Android App Bundle

- chore: make Android analyzer warnings non-fatal

- fix: rotate device identity after account deletion

- chore: format Dart sources for CI

- build: harden Android Play release gate

- feat: verify and cache signed remote policy

- ci: add Android PR validation

- chore: refresh generated mihomo bridge headers

- feat: surface rotated recovery codes in AVEE

- docs: clarify Play updater permission overlay

- feat: add Play country bridge and account deletion flow

- chore: register StoreKit billing plugin

- feat: add backend-driven Android paywall

- style: make Play country guard explicit

- feat: resolve Play storefront country safely

- fix: dispose billing stream with application

- feat: wire Google purchase restore into Android lifecycle

- feat: add Google Play purchase boundary

- chore(android): strip APK install permission from Play builds

- feat: add managed profile refresh with last-known-good

- feat: add Android account recovery flow

- feat: connect AVEE account flow to Android client

- build: stabilize Windows Android toolchain

- test: cover AVEE API client contract

- feat: add AVEE backend API client

- feat: apply AVEE branding to Dropweb baseline

- docs: record Dropweb baseline
...
- ci(release): clean, user-facing changelog notes (filter feat/fix/perf, strip prefixes, dedupe)
...
- release(v0.7.0): ship Play readiness cleanup

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- ci(linux): add manual Linux build workflow

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- release(v0.6.10): ship subscription import update

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- style(ui): polish subscription surfaces

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(dashboard): add explicit settings entry

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(profile): support raw share-link imports

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- fix(profile): update migrated URL subscriptions

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- release(v0.6.9): ship tactile sound update

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- fix(dashboard): avoid redundant mode updates

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(profile): play import result sounds

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(subscription): play refresh cues

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(home): play power toggle sounds

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(app): add native UI sound cues

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- chore(sounds): prune unused glass cues

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- chore(sounds): add retained UI cues

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(home): wire power button haptics

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(app): add native haptic bridge

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(home): add Iris connect button bloom

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- feat(about): show update check on Android

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- fix(update): allow manual prerelease checks

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- fix(update): guard GitHub release checks

- Ultraworked with [Sisyphus](https://github.com/code-yeongyu/oh-my-openagent)

- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>

- fix(update): handle prerelease version tags
...
- feat: use AVEE managed profile service (#4)
...
- * Revert "chore: sync AVEE client branch with Android main"

- This reverts commit a84abc8696ae9435802d7cbcdbd67e5fd9a40ba4, reversing
- changes made to 67827d36c8418bdb773aa16d90fee954b65ffd5e.

- * style: format AVEE client API tests

- * ci: format only AVEE-owned Dart contract files

- * ci: keep upstream analyzer warnings non-fatal

- * ci: build native core for all Android ABIs

- * ci: build flavored debug APK through Gradle

- * ci: use arm64 smoke target for Android build

- * ci: build flavored APK with Flutter target

- ---------

- Co-authored-by: Alexey <enkinvsh@gmail.com>
- Co-authored-by: enkinvsh <95720272+enkinvsh@users.noreply.github.com>
- Co-authored-by: dropweb-ci <ci@dropweb.org>
- Co-authored-by: Sisyphus <clio-agent@sisyphuslabs.ai>
- Co-authored-by: 0x-gg <26283560+0x-gg@users.noreply.github.com>
- Co-authored-by: Cursor <cursoragent@cursor.com>
